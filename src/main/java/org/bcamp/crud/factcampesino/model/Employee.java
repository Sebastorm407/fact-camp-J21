...
public class Employee {
    ...
    public Employee(int id, int number_id, String password_id,String name, String last_name, String birthdate, String address, int phone_number, Gender id_gender, City id_city) {
        super();
        this.id = id;
